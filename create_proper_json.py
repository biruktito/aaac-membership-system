#!/usr/bin/env python3
"""
AAAC Proper Financial Calculation Script
Following the correct AAAC system logic with proper start dates and payment distribution.
"""
...
class AAACProperProcessor:
    ...
    def load_member_data(self, file_path: str) -> Dict[int, Dict]:
        ...
        for _, row in df.iterrows():
            ...
            members[member_id] = {
                ...
                'startDate': None,  # Will be determined from first payment
                'paymentsDues': {},
                'registrationFee': 0,
                'incidentalPayments': [],
                'totalOwed': 0,
                        ...
                        try:
                            ...
                            if reg_amount > 0:
                                if member_id not in payments:
                                    payments[member_id] = {'monthly': {}, 'registration': 0, 'incidental': []}
                                payments[member_id]['registration'] += reg_amount
                        except:
                            pass
    ...
    def match_members_to_payments(self, members: Dict, payments: Dict) -> Dict:
        ...
        for member_id, member_data in members.items():
            ...
            if member_id in payments:
                ...
                member_data['registrationFee'] = payments[member_id].get('registration', 0)
    ...
    def calculate_financials_proper(self, member_data: Dict) -> Dict:
        """Calculate financials using PROPER AAAC rules"""
        payments = member_data['paymentsDues']
        
        # Find first payment month (this becomes the start date)
        ...
        # Set start date to first payment month
        start_date = first_payment_month
        
        # Calculate owed months (from start date to current)
        owed_months = []
        current = start_date
        ...
        # Determine status based on PROPER AAAC rules
    ...
    def process_all_members(self, members: Dict) -> Dict:
        ...
        for member_id, member_data in members.items():
            ...
            financials = self.calculate_financials_proper(member_data)
    ...
    def run(self, members_file: str, payments_file: str, output_file: str):
        ...
        print("Starting AAAC data processing with PROPER calculations...")
...
def main():
    processor = AAACProperProcessor()
    
    # File paths
    members_file = '/Users/birukeyesus/Downloads/AA Ass.xlsx'
    payments_file = '/Users/birukeyesus/Downloads/AAAIC Book (1).xlsx'
    output_file = '/Users/birukeyesus/terraform_practice/aaac-system/docs/cleaned_members_proper.json'
    ...
    for member in result['members'][:5]:
        ...
        print(f"  Registration Fee: ${member['registrationFee']}")
        print()
