#!/usr/bin/env python3
"""
AAAC Data Cleaning and JSON Generation Script
Creates a clean JSON file from Excel spreadsheets with proper financial calculations.
"""
...
class AAACDataProcessor:
    def __init__(self):
        self.members = {}
        self.payments = {}
        self.dues_per_month = 15
        self.current_date = date(2025, 9, 18)
        self.baseline_date = date(2019, 2, 1)  # All members start from Feb 2019
            ...
            try:
                ...
                for _, row in df.iterrows():
                    ...
                    if phone_col and not pd.isna(row[phone_col]):
                        phone = self.clean_phone(row[phone_col])
    ...
    def match_members_to_payments(self, members: Dict, payments: Dict) -> Dict:
        ...
        for member_id, member_data in members.items():
            ...
            if member_id in payments:
                ...
                if payments[member_id]:
                    member_data['phone'] = self.extract_phone_from_payments(member_id, payments[member_id])
                matched_count += 1
                continue
    ...
    def extract_phone_from_payments(self, member_id: int, payment_data: Dict) -> str:
        """Extract phone number from payment data if available"""
        # This would require looking through the original Excel data
        # For now, return empty string
        return ""
    
    def calculate_financials(self, member_data: Dict) -> Dict:
        """Calculate all financial fields for a member"""
    ...
    def process_all_members(self, members: Dict) -> Dict:
        ...
        for member_id, member_data in members.items():
            ...
            financials = self.calculate_financials(member_data)
    ...
    def run(self, members_file: str, payments_file: str, output_file: str):
        ...
        print("Starting AAAC data processing...")
...
def main():
    processor = AAACDataProcessor()
    
    # File paths
    members_file = '/Users/birukeyesus/Downloads/AA Ass.xlsx'
    payments_file = '/Users/birukeyesus/Downloads/AAAIC Book (1).xlsx'
    output_file = '/Users/birukeyesus/terraform_practice/aaac-system/docs/cleaned_members_final_clean.json'
